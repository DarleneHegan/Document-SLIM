                    ...
                    <div class="card card-tabs shadow-sm" style="border-top: 3px solid #ffc107; height: 650px; min-height: 650px; display: flex; flex-direction: column;">
                        ...
                        <div class="card-header p-0 border-bottom-0" style="height: 45px; flex: 0 0 auto; display: flex; align-items: flex-end;">
                            <ul class="nav nav-tabs custom-scroll-tabs mb-0" id="rightTabs" role="tablist" style="flex-wrap: nowrap; overflow-x: auto; overflow-y: hidden; white-space: nowrap; margin-bottom: 0;">
                                ...
                                <!-- TAMBAHAN CODE TAB SUP DOC MULAI DARI SINI -->
                                <li class="nav-item" style="flex: 0 0 auto;">
                                    <a class="nav-link text-dark font-weight-bold" id="tab-sup-doc" data-toggle="pill" href="#content-sup-doc" title="Sup Doc" style="height: 45px; display: flex; align-items: center; gap: 8px; padding: 0 15px;">
                                        <i class="fas fa-file-alt" style="font-size: 12px; color: #2c3e50;"></i>
                                        <span style="font-size: 11px;">Sup Doc</span>
                                    </a>
                                </li>
                                <?php endif; ?>
                        ...
                        <div class="card-body p-0" style="flex: 1 1 auto; overflow: hidden;">
                             <div class="tab-content h-100">
                                ...
                                <div class="tab-pane fade h-100" id="content-sup-doc">
                                    <div class="d-flex flex-column h-100">
                                        <div class="table-responsive scrollable-card-body p-0" style="flex: 1 1 auto; overflow-y: auto; min-height: 0;">
                                            <table class="table table-striped table-bordered table-hover text-sm m-0 w-100 text-center">
...
<script>
    ...
    // TAMBAHAN JS SUP DOC MULAI DARI SINI
    window.downloadSupDoc = function(downloadUrl) {
        Swal.fire({
            title: 'Download Dokumen Pendukung?',
            text: "Dokumen ini akan diunduh ke perangkat Anda.",
            icon: 'question',
            showCancelButton: true,
            confirmButtonText: 'Yes, download',
    ...
    window.confirmUploadSupDoc = function(appId) {
        ...
        Swal.fire({
            ...
            html: "<p style='margin-bottom: 15px; font-size: 14px;'>Upload dokumen pendukung (Sup Doc) yang dibutuhkan.</p>" +
                  "<div class='text-left px-2'>" +
                  "<label class='font-weight-normal' style='font-size: 14px;'>Pilih File (.pdf, .doc, .docx, .xls, .xlsx, .zip, .rar) <span class='text-danger'>*</span></label>" +
                  "<input type='file' id='swal-upload-sup-doc' name='sup_doc_file' class='form-control' accept='.pdf, .doc, .docx, .xls, .xlsx, .zip, .rar' style='padding: 3px;'>" +
                  "</div>",
            icon: 'info',
            showCancelButton: true,
            confirmButtonText: 'Yes, Upload',
            ...
            if (result.isConfirmed) {
                let safeFileInput = result.value.fileInput;
                ...
                let orphanedInput = document.getElementById('swal-upload-sup-doc');
                if (orphanedInput) orphanedInput.remove();
            }
        });
    }
